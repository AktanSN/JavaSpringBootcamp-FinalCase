...
function HomePage() {
  ...
  return (
       <>
        ...
        <div className="col text-center">
        <h1 style={{ color: 'white', fontWeight: 'bold', marginTop: '20px', marginRight: '-500px' }}>Akbank Java Spring </h1>
        <h1 style={{ color: 'white', fontWeight: 'bold', marginRight: '-500px' }}>Bootcamp</h1>
        <p style={{ color: 'white', fontWeight: 'bold', marginRight: '-500px' }}>Bitirme Projesi</p>
          </div>
          </div>
        </div>
        </div>
